...
To install Knxproj, run this command in your terminal:

.. code-block:: console

    $ pip install knxproj

This is the preferred method to install Knxproj, as it will always install the most recent stable release.
